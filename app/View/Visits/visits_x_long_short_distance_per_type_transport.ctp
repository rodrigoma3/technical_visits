<div class="widget widget-nopad">
    <div class="widget-header">
        <h3> <?php echo __('Technical visits x long and short distance per type transport'); ?></h3>
    </div>
    <!-- /widget-header -->
...
var chartBar = new Chart(ctx, {
    ...
    options: {
        title: {
            display: true,
            text: "<?php echo __('Technical visits x long and short distance per type transport'); ?>",
        },
        responsive: true,
        scales: {
            yAxes: [{
