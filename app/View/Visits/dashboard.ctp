...
<div class="widget widget-nopad">
    <div class="widget-header"> <i class="icon-fa fa fa-calendar"></i>
        <h3> <?php echo __('Calendar of technical visits'); ?></h3>
    </div>
    <!-- /widget-header -->
    <div class="widget-content">
        <div class="widget big-stats-container">
...
$(window).load(function() {
    var initialLocaleCode = "<?php echo Configure::read('Config.language'); ?>";
