<div class="widget visits form">
	...
	<div class="widget-content">
		<?php
			...
			echo $this->Form->input('transport_cost', ['disabled' => true, 'between' => '<span class="add-on add-on-left">R$</span>', 'div' => 'input text input-prepend input-append', 'escape' => false, 'after' => '<p class="help-block">'.$cost_per_km.'</p>']);
		?>
