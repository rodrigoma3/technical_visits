...
<div class="login-fields">
    ...
    <?php
        echo $this->Form->input('username', array('label' => false, 'placeholder' => __('Username'), 'class' => 'login username-field', 'div' => 'field input-prepend', 'id' => 'username', 'before' => '<span class="add-on"><i class="fa fa-user"></i></span>'));
